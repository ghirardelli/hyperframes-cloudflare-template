...
Provide an authenticated Studio route for editing, persisting, rendering, searching, sharing, and publishing permission-scoped projects with a live HyperFrames preview.
