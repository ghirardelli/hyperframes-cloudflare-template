# organization-publishing Specification

## Purpose

Enable users to publish, catalog, and remix projects strictly within their assigned organization, surfacing an organization-scoped playground modeled on HyperFrames' Community Playground.
