...
Persist projects, generation output, and render output scoped to an owning organization, enforcing project permissions on all reads, mutations, and render access.
