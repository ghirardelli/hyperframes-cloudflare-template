# tenant-projects Specification

## Purpose

Persist projects, generation output, and render output scoped to an owning organization, enforcing organization-based authorization on all reads, mutations, and render access.
